...
#[VForm(
    title: "Skyblock Ban Player Form",
    type: TypeForm::CUSTOM_FORM,
    content: "-",
)]
final class FormBanPlayer extends Form
{
    ...
    public function __construct(Player $player)
    {
        ...
        $this->dataForm = $this->plugin->getProvider()->getConfigProvider()->getForms()->getNested(ConfigPaths::FORMS_BAN_PLAYER_SKYBLOCK_FORM);
    ...
    public function banPlayer(Player $player, mixed $data): void
    {
