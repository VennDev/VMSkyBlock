...
final class GetStringFormPlayer extends VResultString
{
    ...
    {
        $dataForm = VMSkyBlock::getInstance()->getProvider()->getConfigProvider()->getForms()->getNested(ConfigPaths::FORMS_SKYBLOCK_FORM);
