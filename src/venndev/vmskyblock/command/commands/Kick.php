...
final class Kick extends SubCommand
{
    ...
    public function __construct()
    {
        parent::__construct(
            "kick",
            "Kick a player from your island. This is command funny for all members of the island.",
            "kick <player>",
            [
                "kk",
            ]
        ...
        $this->setPermission(Permissions::COMMAND_KICK);
    }
    ...
    protected function execute(CommandSender $sender, array $args): void
    {
        if ($sender instanceof Player) {
            if (isset($args[0])) {
                ...
                if ($player) {
                    VMSkyBlock::getInstance()->getManager()->kick($sender, $player);
                } else {
